...
//  LCD_ShowString(30,300,200,16,16,dtbuf);		  
 ...
 { 
	...
	printf("i am ok_1!!!\n");
	USART4_Init(38400);  //初始化串口2波特率为115200
//	printf("i am ok_2!!!\n");
//	u4_printf("123\n");
	LED_Init();         	//LED初始化
	printf("i am ok_3!!!\n");	
...
//   	LCD_ShowString(30,120,200,16,16,"S1216F8-BD Setting...");
		...
		do
		{
			USART4_Init(9600);			//初始化串口4波特率为9600
			SkyTra_Cfg_Prt(3);			//重新设置模块的波特率为38400
			USART4_Init(38400);			//初始化串口4波特率为38400
